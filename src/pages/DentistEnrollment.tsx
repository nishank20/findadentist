        ...
        <main className="container max-w-3xl mx-auto px-4 py-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p>Practices using Dental.com Office may receive priority placement, but use of Dental.com Office is not a requirement for listing.</p>
              <Button
                onClick={() => navigate("/")}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <form onSubmit={handleNext} className="space-y-8">
            ...
            <div className="text-center text-sm text-gray-600 pt-6">
              ...
              <a href="#" className="text-blue-600 hover:underline">Privacy Practices</a>, and{" "}
              <a href="#" className="text-blue-600 hover:underline">Affiliated Dental Provider Notice of Privacy Practices</a>
            </div>
          </form>
        </div>
      </main>
